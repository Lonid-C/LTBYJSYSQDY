"""Extract the V3 source bundle and install its pinned Colab environment."""
from pathlib import Path
import os,platform,subprocess,sys,tarfile
ARCHIVE=Path('/content/q2_v3_source.tar.gz');DEST=Path('/content/CUMCM_2026_Last_Dance')
...
subprocess.run([sys.executable,'-m','pip','install','-q','openpyxl','scikit-learn','matplotlib','pandas','scipy==1.15.3','nbformat','tabulate'],check=True)
